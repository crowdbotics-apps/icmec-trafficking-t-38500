...
## Project Structure
    ...
    ├── icmec_trafficking_t_38500  # Django project configurations
...
1. Clone this repo and `cd icmec_trafficking_t_38500`
...
2. Clone this repo and `cd icmec_trafficking_t_38500`
